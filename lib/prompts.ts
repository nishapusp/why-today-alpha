...
- If field=deepDiveRead: use Google Search to check 1-2 current sources for this specific story if possible, then write 900-1400 words using these 5 headers, each meeting its own length floor: ## What Changed (150-250 words), ## The Backstory (150-250 words), ## Why It Matters (200-300 words), ## Broader Connections (150-250 words), ## Alternative View (150-200 words). Open with a "Fast Facts" bullet list (lines starting with "- "), use **bold** on key numbers, include a "Then vs. now:" comparison paragraph, and vary sentence rhythm — never a wall of uniform paragraphs.
